...
public class GuiKeyBinds extends GuiScreen
{
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        drawCenteredString(fontRendererObj, StatCollector.translateToLocal(screenTitle), width / 2, 4, 0xffffff);
        
        drawCenteredString(fontRendererObj, StatCollector.translateToLocal("morph.gui.keybinds.selector") + " " + StatCollector.translateToLocal("morph.gui.keybinds.up"),  1 * (width - 320) / 5 + 40, 30, 0xffffff);
        drawCenteredString(fontRendererObj, StatCollector.translateToLocal("morph.gui.keybinds.selector") + " " + StatCollector.translateToLocal("morph.gui.keybinds.down"),  2 * (width - 320) / 5 + 80 + 40, 30, 0xffffff);
        drawCenteredString(fontRendererObj, StatCollector.translateToLocal("morph.gui.keybinds.selector") + " " + StatCollector.translateToLocal("morph.gui.keybinds.left"),  3 * (width - 320) / 5 + 160 + 40, 30, 0xffffff);
        drawCenteredString(fontRendererObj, StatCollector.translateToLocal("morph.gui.keybinds.selector") + " " + StatCollector.translateToLocal("morph.gui.keybinds.right"),  4 * (width - 320) / 5 + 240 + 40, 30, 0xffffff);
        
        drawCenteredString(fontRendererObj, StatCollector.translateToLocal("morph.gui.keybinds.selector") + " " + StatCollector.translateToLocal("morph.gui.keybinds.choose"),  1 * (width - 320) / 5 + 40, 100, 0xffffff);
        drawCenteredString(fontRendererObj, StatCollector.translateToLocal("morph.gui.keybinds.selector") + " " + StatCollector.translateToLocal("morph.gui.keybinds.cancel"),  2 * (width - 320) / 5 + 80 + 40, 100, 0xffffff);
        drawCenteredString(fontRendererObj, StatCollector.translateToLocal("morph.gui.keybinds.selector") + " " + StatCollector.translateToLocal("morph.gui.keybinds.remove"),  3 * (width - 320) / 5 + 160 + 40, 100, 0xffffff);
        drawCenteredString(fontRendererObj, StatCollector.translateToLocal("morph.gui.keybinds.favorite"),  4 * (width - 320) / 5 + 240 + 40, 100, 0xffffff);
